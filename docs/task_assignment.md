...
This document tracks the planned and confirmed responsibilities for each team member.

## Current Status

The team has not finalized the task division yet. The repository has been initialized with a modular structure so that each member can later work on a separate component.
